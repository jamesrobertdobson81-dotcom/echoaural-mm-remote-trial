#!/usr/bin/env python3
"""Generate Melody Master level icons with transparent backgrounds.

Removes the blue gradient tile from shared level PNGs, keeping white line art.
Original assets in assets/icons/levels/ are unchanged (used by other modules).
...
SRC_DIR = ROOT / "assets" / "icons" / "levels"
OUT_DIR = SRC_DIR / "mm-transparent"
NAMES = ("foundation", "developing", "securing", "mastering")
OUT_SIZE = 256
