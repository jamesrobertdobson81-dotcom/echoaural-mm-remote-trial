#!/usr/bin/env python3
"""Generate the three newest skill icons with transparent backgrounds:
Texture Trainer "Textural Devices", Meter Master "Rhythmic Devices", and
Harmony Explorer "Chord Identifier".

Same badge-to-line-art pipeline as tools/make_cc_skill_icons_transparent.py.
...
ICON_DIR = ROOT / "assets" / "icons" / "modules"
OUT_SIZE = 256
FIT_SCALE = 0.98

# name -> (source file, output path)
SOURCES = {
    "textural-devices": (DESKTOP / "TexturalDevices.png", ICON_DIR / "tt-transparent" / "textural-devices-transparent.png"),
    "rhythmic-devices": (DESKTOP / "RhythmicDevices.png", ICON_DIR / "meter-transparent" / "rhythmic-devices-transparent.png"),
    "chord-identifier": (DESKTOP / "ChordIdentifier.png", ICON_DIR / "he-transparent" / "chord-identifier-transparent.png"),
}
