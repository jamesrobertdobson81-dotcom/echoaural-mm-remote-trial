...
// key-signature-sprint, chord-identifier, era-explorer) — 11 module ids,
// deliberately hand-kept in sync
...
const REGISTERED_CLASSROOM_MODULE_IDS = [
  ...
  'ensemble-recognition', 'cadence-coach', 'meter-master', 'musical-language', 'key-signature-sprint',
  'chord-identifier', 'era-explorer'
];
...
test('all 16 PM sources now have a classroom adapter, including all four seed-mode sources', () => {
  ...
  assert.equal(registry.all().length, 16);
  assert.deepEqual(
