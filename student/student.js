(() => {
  ...
  function getModulePresentation(moduleId = 'mixed') {
    ...
    if (moduleId === 'key-signature-sprint') {
      return { id: moduleId, title: 'Key Signature Sprint', main: 'Key Signature', gradient: 'Sprint', icon: '/assets/icons/modules/harmony-explorer.png', hint: 'Read the key signature and choose the matching key.' };
    }
    return {
      id: 'mixed',
      title: 'Mixed Apps',
