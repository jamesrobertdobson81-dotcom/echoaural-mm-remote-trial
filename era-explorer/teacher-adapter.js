...
module.exports = function createContextCoachTeacherAdapter(context = {}) {
  ...
  // Inlined rather than required from classroom/question-set-builder.js —
  // that file pulls in classroom/elo.js's homework/adaptive-targeting
  // system, which this adapter has no other need for. Same seeded-PRNG
  // algorithm modules/harmony-explorer/key-signature-sprint/key-signature-
  // core.js already carries its own copy of, for the same reason.
